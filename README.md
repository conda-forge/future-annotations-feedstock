...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/future-annotations-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14301&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/future-annotations-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `future-annotations` can be installed with:

```
conda install future-annotations
```

It is possible to list all of the versions of `future-annotations` available on your platform with:
